...
/**
 * Singleton GUI class for the login window.
 * Contains a button listener for password submission and verification
 *
 * @version 17 Jun 2023
...
public class LoginGUI extends JFrame implements ActionListener{
	...
	/**
	 * Returns the singleton instance of LoginGUI.
	 *
	...
	/**
	 * Called when an action event is generated by the loginButton.
	 * This method handles the action event and performs password verification. Depending on the result of the verification,
	 * the next window gets constructed, or an error message pops up.
	 * 
